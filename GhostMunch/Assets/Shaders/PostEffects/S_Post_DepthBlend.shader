...
////// Emissive:
                ...
                float4 node_7937 = _Time + _TimeEditor;
                float2 node_290 = (i.uv0+node_7937.g*float2(0.11798,0.06598));
                float4 node_3842 = tex2D(_Noise,TRANSFORM_TEX(node_290, _Noise));
                float2 node_4575 = (i.uv0+node_7937.g*float2(0.05649,0.05468));
