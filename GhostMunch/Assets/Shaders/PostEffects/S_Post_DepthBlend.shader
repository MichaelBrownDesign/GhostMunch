...
////// Emissive:
                ...
                float4 node_3924 = _Time + _TimeEditor;
                float2 node_290 = (i.uv0+node_3924.g*float2(0.01,0.01));
                float4 node_3842 = tex2D(_Noise,TRANSFORM_TEX(node_290, _Noise));
                float2 node_4575 = (i.uv0+node_3924.g*float2(-0.01,0.01));
