...
/*SF_DATA;ver:1.37;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,lico:1,lgpr:1,limd:0,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:3,bdst:7,dpts:2,wrdp:False,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:9361,x:33560,y:32717,varname:node_9361,prsc:2|emission-2460-OUT,custl-5085-OUT,alpha-5482-OUT;n:type:ShaderForge.SFN_LightAttenuation,id:8068,x:32734,y:33086,varname:node_8068,prsc:2;n:type:ShaderForge.SFN_LightColor,id:3406,x:32734,y:32952,varname:node_3406,prsc:2;n:type:ShaderForge.SFN_LightVector,id:6869,x:31858,y:32654,varname:node_6869,prsc:2;n:type:ShaderForge.SFN_NormalVector,id:9684,x:31858,y:32782,prsc:2,pt:True;n:type:ShaderForge.SFN_HalfVector,id:9471,x:31858,y:32933,varname:node_9471,prsc:2;n:type:ShaderForge.SFN_Dot,id:7782,x:32070,y:32697,cmnt:Lambert,varname:node_7782,prsc:2,dt:1|A-6869-OUT,B-9684-OUT;n:type:ShaderForge.SFN_Dot,id:3269,x:32070,y:32871,cmnt:Blinn-Phong,varname:node_3269,prsc:2,dt:1|A-9684-OUT,B-9471-OUT;n:type:ShaderForge.SFN_Multiply,id:2746,x:32465,y:32866,cmnt:Specular Contribution,varname:node_2746,prsc:2|A-7782-OUT,B-5267-OUT,C-4865-RGB;n:type:ShaderForge.SFN_Tex2d,id:851,x:32115,y:32369,ptovrint:False,ptlb:Diffuse,ptin:_Diffuse,varname:node_851,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Multiply,id:1941,x:32465,y:32693,cmnt:Diffuse Contribution,varname:node_1941,prsc:2|A-851-RGB,B-7782-OUT;n:type:ShaderForge.SFN_Exp,id:1700,x:32070,y:33054,varname:node_1700,prsc:2,et:1|IN-9978-OUT;n:type:ShaderForge.SFN_Slider,id:5328,x:31529,y:33056,ptovrint:False,ptlb:Gloss,ptin:_Gloss,varname:node_5328,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.5,max:1;n:type:ShaderForge.SFN_Power,id:5267,x:32268,y:32940,varname:node_5267,prsc:2|VAL-3269-OUT,EXP-1700-OUT;n:type:ShaderForge.SFN_Add,id:2159,x:32734,y:32812,cmnt:Combine,varname:node_2159,prsc:2|A-1941-OUT,B-2746-OUT;n:type:ShaderForge.SFN_Multiply,id:5085,x:32979,y:32952,cmnt:Attenuate and Color,varname:node_5085,prsc:2|A-2159-OUT,B-3406-RGB,C-8068-OUT;n:type:ShaderForge.SFN_ConstantLerp,id:9978,x:31858,y:33056,varname:node_9978,prsc:2,a:1,b:11|IN-5328-OUT;n:type:ShaderForge.SFN_Color,id:4865,x:32268,y:33095,ptovrint:False,ptlb:Spec Color,ptin:_SpecColor,varname:node_4865,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:1,c3:1,c4:1;n:type:ShaderForge.SFN_AmbientLight,id:7528,x:32734,y:32515,varname:node_7528,prsc:2;n:type:ShaderForge.SFN_Multiply,id:2460,x:32980,y:32432,cmnt:Ambient Light,varname:node_2460,prsc:2|A-851-RGB,B-7528-RGB;n:type:ShaderForge.SFN_ViewVector,id:4568,x:32165,y:33566,varname:node_4568,prsc:2;n:type:ShaderForge.SFN_Dot,id:8583,x:32455,y:33740,varname:node_8583,prsc:2,dt:0|A-4568-OUT,B-5682-OUT;n:type:ShaderForge.SFN_Slider,id:4658,x:32413,y:33614,ptovrint:False,ptlb:Dot,ptin:_Dot,varname:node_4658,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:-1,cur:-1,max:1;n:type:ShaderForge.SFN_Divide,id:9065,x:32844,y:33584,varname:node_9065,prsc:2|A-4658-OUT,B-7457-OUT;n:type:ShaderForge.SFN_Clamp01,id:9037,x:33048,y:33606,varname:node_9037,prsc:2|IN-9065-OUT;n:type:ShaderForge.SFN_OneMinus,id:5482,x:33283,y:33508,varname:node_5482,prsc:2|IN-9037-OUT;n:type:ShaderForge.SFN_FragmentPosition,id:9482,x:31353,y:33808,varname:node_9482,prsc:2;n:type:ShaderForge.SFN_ViewPosition,id:2053,x:31353,y:33983,varname:node_2053,prsc:2;n:type:ShaderForge.SFN_Subtract,id:6129,x:31903,y:33723,varname:node_6129,prsc:2|A-5104-OUT,B-7382-OUT;n:type:ShaderForge.SFN_Normalize,id:5682,x:32207,y:33750,varname:node_5682,prsc:2|IN-6129-OUT;n:type:ShaderForge.SFN_Length,id:7545,x:32168,y:33885,varname:node_7545,prsc:2|IN-6129-OUT;n:type:ShaderForge.SFN_Multiply,id:7457,x:32633,y:33757,varname:node_7457,prsc:2|A-8583-OUT,B-4962-OUT;n:type:ShaderForge.SFN_Power,id:9754,x:32382,y:33914,varname:node_9754,prsc:2|VAL-7545-OUT,EXP-8032-OUT;n:type:ShaderForge.SFN_Divide,id:4962,x:32585,y:33927,varname:node_4962,prsc:2|A-9754-OUT,B-1011-OUT;n:type:ShaderForge.SFN_Multiply,id:7382,x:31802,y:33977,varname:node_7382,prsc:2|A-2053-XYZ,B-865-OUT;n:type:ShaderForge.SFN_Vector3,id:865,x:31505,y:33905,varname:node_865,prsc:2,v1:1,v2:0,v3:1;n:type:ShaderForge.SFN_Multiply,id:5104,x:31669,y:33758,varname:node_5104,prsc:2|A-9482-XYZ,B-865-OUT;n:type:ShaderForge.SFN_Slider,id:8032,x:31960,y:34150,ptovrint:False,ptlb:FadeFallOff,ptin:_FadeFallOff,varname:node_8032,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:3,max:10;n:type:ShaderForge.SFN_Slider,id:1011,x:32301,y:34243,ptovrint:False,ptlb:FadeLevel,ptin:_FadeLevel,varname:node_1011,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:2000,max:10000;proporder:851-5328-4865-4658-8032-1011;pass:END;sub:END;*/
...
////// Emissive:
                ...
                fixed4 finalRGBA = fixed4(finalColor,(1.0 - saturate((_Dot/(dot(viewDirection,normalize(node_6129))*(pow(length(node_6129),_FadeFallOff)/_FadeLevel))))));
...
////// Lighting:
                ...
                float3 node_865 = float3(1,0,1);
                float3 node_6129 = ((i.posWorld.rgb*node_865)-(_WorldSpaceCameraPos*node_865));
                fixed4 finalRGBA = fixed4(finalColor * (1.0 - saturate((_Dot/(dot(viewDirection,normalize(node_6129))*(pow(length(node_6129),_FadeFallOff)/_FadeLevel))))),0);
                UNITY_APPLY_FOG(i.fogCoord, finalRGBA);
                return finalRGBA;
            }
            ENDCG
