...
////// Emissive:
                ...
                float node_4962 = (pow(length(((((Function_node_9186( node_2999 , node_791 , node_3827 , node_7278 )+i.posWorld.rgb)*node_865)-(i.posWorld.rgb*node_865))*_FadeAxisBias.rgb)),_FadeFallOff)/_FadeLevel);
                fixed4 finalRGBA = fixed4(finalColor,clamp(node_4962,_MinAlpha,1.0));
...
////// Lighting:
                ...
                float3 node_865 = float3(1,0,1);
                float node_4962 = (pow(length(((((Function_node_9186( node_2999 , node_791 , node_3827 , node_7278 )+i.posWorld.rgb)*node_865)-(i.posWorld.rgb*node_865))*_FadeAxisBias.rgb)),_FadeFallOff)/_FadeLevel);
                fixed4 finalRGBA = fixed4(finalColor * clamp(node_4962,_MinAlpha,1.0),0);
                UNITY_APPLY_FOG(i.fogCoord, finalRGBA);
                return finalRGBA;
            }
            ENDCG
