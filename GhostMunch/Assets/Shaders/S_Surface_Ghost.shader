...
////// Specular:
                ...
                float3 diffuseColor = (lerp(float3(1,1,1),saturate(3.0*abs(1.0-2.0*frac((node_3700.r*_Hue)+float3(0.0,-1.0/3.0,1.0/3.0)))-1),(node_3700.g*_Saturation))*(node_3700.b*_Brightness)); // Need this for specular when using metallic
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float node_3700_e = 1.0e-10;
                float3 node_3700 = float3(abs(node_3700_q.z + (node_3700_q.w - node_3700_q.y) / (6.0 * node_3700_d + node_3700_e)), node_3700_d / (node_3700_q.x + node_3700_e), node_3700_q.x);;
                float3 diffColor = (lerp(float3(1,1,1),saturate(3.0*abs(1.0-2.0*frac((node_3700.r*_Hue)+float3(0.0,-1.0/3.0,1.0/3.0)))-1),(node_3700.g*_Saturation))*(node_3700.b*_Brightness));
                float specularMonochrome;
                float3 specColor;
