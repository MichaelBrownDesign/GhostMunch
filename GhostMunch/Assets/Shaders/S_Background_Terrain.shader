        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float Tessellation(TessVertex v){
                    ...
                    float3 node_4948 = (_MainTex_var.rgb-_BlurTex_var.rgb);
                    float node_2779 = length(node_4948);
                    float node_8206_if_leA = step(node_2779,0.15);
                    float node_8206_if_leB = step(0.15,node_2779);
                    float node_100 = 1.0;
...
////// Emissive:
                ...
                float node_2779 = length(node_4948);
                float node_3131 = saturate((node_2779+0.2));
                float node_8322_if_leA = step(node_3131,0.5);
                float node_8322_if_leB = step(0.5,node_3131);
                float node_5687 = 0.0;
                fixed4 finalRGBA = fixed4(finalColor,lerp((node_8322_if_leA*node_5687)+(node_8322_if_leB*node_3131),node_5687,node_8322_if_leA*node_8322_if_leB));
...
////// Lighting:
                ...
                float node_8322_if_leB = step(0.5,node_3131);
                float node_5687 = 0.0;
                fixed4 finalRGBA = fixed4(finalColor * lerp((node_8322_if_leA*node_5687)+(node_8322_if_leB*node_3131),node_5687,node_8322_if_leA*node_8322_if_leB),0);
                UNITY_APPLY_FOG(i.fogCoord, finalRGBA);
                return finalRGBA;
            }
            ENDCG
