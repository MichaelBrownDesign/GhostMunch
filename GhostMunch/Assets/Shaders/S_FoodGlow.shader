...
Shader "Shader Forge/S_FoodGlow" {
    Properties {
        ...
        _MetallicCol ("MetallicCol", Color) = (0,0,0,1)
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
...
////// Specular:
                ...
                float3 specularColor = _MetallicCol.r;
...
////// Emissive:
                float4 node_2376 = _Time + _TimeEditor;
                float2 node_1498 = ((i.uv0+node_2376.g*float2(1,1))*_PanSpeed);
