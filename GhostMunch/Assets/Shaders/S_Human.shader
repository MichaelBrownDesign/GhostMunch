...
///////// Gloss:
                ...
                float gloss = _Roughness_var.r;
                float perceptualRoughness = 1.0 - _Roughness_var.r;
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _Roughness_var = tex2D(_Roughness,TRANSFORM_TEX(i.uv0, _Roughness));
                float roughness = 1.0 - _Roughness_var.r;
